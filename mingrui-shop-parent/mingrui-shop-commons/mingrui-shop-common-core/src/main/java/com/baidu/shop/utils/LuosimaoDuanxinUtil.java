...
public class LuosimaoDuanxinUtil {
    ...
    //短信平台的APIkey
    private static final String DUANXIN_API_KEY = "key-ed55127507f21949064db9373db7a63b";//需要使用自己的APIkey
    private static final String SPEAK_API_KEY = "key-8385c7ea4b871a4e09ffc7abeaf3ed63";//需要使用自己的APIkey
